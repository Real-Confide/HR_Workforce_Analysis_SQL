...
Cleaning included:
•	Converting ReviewID, EmployeeID and ReviewerEmployeeID to integers
...
•	SQL Views
•	Multiple CTEs
•	Combining aggregated and employee-level data
...
└── sql/
    ...
    ├── clean_employees.sql
    ├── clean_attendance.sql
    ├── clean_performance_reviews.sql
    ├── eda.sql
    ├── advanced_analysis.sql
    ├── active_employee_report.sql
    └── exited_employee_report.sql
